...
<body>
    ...
    <legend class="scheduler-border">Upload Employee Details</legend>
		<div class = "container">
		<br>
			<form name="myform" action = "/addEmployee" method = "post" align="center">
  					<div class="row">
                    ...
                    <div class="row">
                        ...
                        <input type = "text"  class="col-md-4" name = "empName" required maxlength="100"/>
                    </div>
                    <br>

                    <div class="row">
                            <label class="col-md-6" >Location : </label>
							<textarea style="overflow:auto;" class="col-md-4" name="empLoc" cols="20" rows="2" required maxlength="500"></textarea>						
					</div>
                    <br>

                    <div class="row">
                            <label class="col-md-6" >E-Mail  : </label>
							<input type = "text" name = "empMail" class="col-md-4" required maxlength="100"/>
                    </div>

                    <br>
                    <div class="row">
                            <label class="col-md-6">Date of birth  : </label>
							<input type = "text" name = "empDOB" class="col-md-4" required/> 
                    </div>
                    <br>
